    ...
    def handle(self, *args, **options):
        ...
        with transaction.atomic():
            ...
            example_groups = [
                [
                    "Cheshire Chess Club",
                    "A place for us to plan events and and tournaments.",
                ],
                [
                    "Hoxton Hockey Team",
                    "A welcoming group, ready for new members, and new collaborations!",
                ],
                [
                    "Burnley Bakers",
                    "We often charity hold events in store, which we could use some help with",
                ],
                [
                    "Southside Five-a-side Club",
                    "Projects are incoming, and we are going to need to pull together",
                ],
                ["Brixton Bowling Team", "All for one, and one for all....."],
                [
                    "Peppersfield Parents",
                    "A group of concerns parents, wanting to make a difference..",
                ],
                [
                    "St Ives Community",
                    "A group for the St. Ives community to plan events",
                ],
                [
                    "March Town Committee",
                    "We plan many small festivals and fairs throughout the year",
                ],
                ["St Nicholas Church", "Church related events and community projects"],
                [
                    "Giger Art Appreciation",
                    "Collaborative art Projects that are based around the work of H.R. Giger",
                ],
                ["Hard Rock Online Meetup", "Music collabs, hard rock, adn beers!"],
                [
                    "Online Art Community",
                    "Large sale Online Art projects for all abilities",
                ],
                [
                    "Secret Garden Party",
                    "Space for organisers of the festival entertainment",
                ],
                [
                    "Buntingford Festival Committee",
                    "Planning festivals and fairs since 1978",
                ],
                ["Wool & Wine", "Knitting (and drinking) projects.... "],
                [
                    "Royston Town Council",
                    "Note: Not for official business, please contact the office for inquiries",
                ],
                [
                    "Dabapps devs",
            ...
            for group in Group.objects.filter(id__in=new_group_ids):
                for user in User.objects.all():
                    ...
                    ).exists() and random.getrandbits(1):
                        if random.getrandbits(1):
                            Membership.objects.create(
                                group=group, user=user, status=MEMBERSHIP_STATUS_CURRENT
                            )
                            ...
                            if random.getrandbits(1):
                                ...
                                if random.getrandbits(1) and random.getrandbits(1):
                                    ...
                                    Membership.objects.create(
                                        group=group,
                                        user=user,
                                        status=MEMBERSHIP_STATUS_IGNORED,
                                    )
                                    memberships_created += 1
