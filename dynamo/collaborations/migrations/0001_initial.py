    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reference', models.CharField(default='REF', help_text='An auto-generated task reference, used to assign task as prerequisites', max_length=255)),
                ('name', models.CharField(help_text="A name for the milestone e.g. 'Stage 1 Preparations complete!'", max_length=100)),
                ('target_date', models.DateTimeField(blank=True, help_text='A date by which the group should aim to reach this milestone', null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, help_text='A further description of the task and what is required', max_length=500, null=True)),
                ('completed_at', models.DateTimeField(blank=True, help_text='Timestamp of when this task was completed.', null=True)),
                ('completion_notes', models.TextField(blank=True, help_text='Any information relevant to the completion of this task. ', max_length=500, null=True)),
            ],
            options={
