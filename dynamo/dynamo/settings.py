...
"""
Simple JWT & Cors for React interaction
"""
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:3000",  # Will allow requests from React app during dev
    "http://127.0.0.1:3000",  # Will allow requests from React app during dev
]
